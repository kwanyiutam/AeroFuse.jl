...
begin
	ParseData = ingredients("./parsedata.jl").ParseData;
...
# ╔═╡ 5f83a2cd-2234-4497-ba72-8c6afc0bf3f0
md"""
## Load Defaults
"""

# ╔═╡ a0b2c46a-3318-4d42-968a-8b940c66bb46
begin
	regulation = ParseData.get_data(data = "Regulations", rowname_only = true);
	aircraft_type = ParseData.get_data(data = "PlaneRef", rowname_only = true);
end

# ╔═╡ 9c5031c4-a818-4154-b7b3-1c792cb5685d
(df1, df2) = ParseData.assumption_init(aircraft_type = aircraft_type[1], regulation = regulation[1])
